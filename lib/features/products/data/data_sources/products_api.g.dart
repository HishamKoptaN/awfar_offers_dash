...
class _ProductsApi implements ProductsApi {
  ...
  @override
  Future<List<Product>?> getProducts({required int offerId}) async {
  ...
  @override
  Future<Product> addProduct({required FormData formData}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<Product> edit({required Product product}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = product;
