...
class _CouponsApi implements CouponsApi {
  _CouponsApi(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  Future<List<Coupon>> getCoupons() async {
    ...
    final _options = _setStreamType<List<Coupon>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<Coupon> addCoupon(
    ...
    _data.addAll(addCouponRequestModel.toJson());
    final _options = _setStreamType<Coupon>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
