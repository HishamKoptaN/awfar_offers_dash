...
class _$NotificationImpl implements _Notification {
  ...
  @override
  String toString() {
    return 'Notification(id: $id, type: $type, message: $message, notifiableId: $notifiableId, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, type, message, notifiableId, createdAt, updatedAt);
...
abstract class _Notification implements Notification {
  const factory _Notification(
          ...
          @JsonKey(name: "public") final bool? type,
          @JsonKey(name: "message") final String? message,
          @JsonKey(name: "notifiable_id") final String? notifiableId,
