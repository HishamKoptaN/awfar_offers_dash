...
mixin _$MainState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(User user) notVerify,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(User user)? notVerify,
...
class _$NotVerifyImpl implements _NotVerify {
  const _$NotVerifyImpl({required this.user});
  ...
  @override
  String toString() {
    return 'MainState.notVerify(user: $user)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$NotVerifyImplCopyWith<_$NotVerifyImpl> get copyWith =>
      __$$NotVerifyImplCopyWithImpl<_$NotVerifyImpl>(this, _$identity);
...
abstract class _NotVerify implements MainState {
  const factory _NotVerify({required final User user}) = _$NotVerifyImpl;
